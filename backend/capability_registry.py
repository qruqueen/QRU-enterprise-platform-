...
DEFINITIONS = [
    ...
    _c("podcast-studio", "Podcast Studio™", "future", "future", None, None,
       "Audio & video podcast manufacturing.", "Stone 3 of this initiative.",
       note="Reuses narration, Voice Profiles™, KRs — no duplicate workflows."),
