...
def _build_registry():
    connectors = [
        QRUStoreConnector(),
        YouTubeConnector(),
        _stub("wordpress", "WordPress / Blog", ConnectorKind.PUBLISH, "Blog", False,
              [DistMode.DRAFT, DistMode.PUBLIC], ["article", "image"],
              "WordPress publishing (posts + featured image) is a planned connector."),
